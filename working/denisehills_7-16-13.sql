...
--
-- Host: localhost
-- Generation Time: Jul 16, 2013 at 11:01 PM
...
('d52ef99bd7c664d0c665ea55a5bb60a0', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_4) App', 1374033585, 'a:3:{s:13:"admin_user_id";s:1:"1";s:15:"admin_logged_in";b:1;s:11:"admin_roles";s:0:"";}');
...
(12, 'footer_right', 'the far right spot on the footer', '<h3>Find Us On the Web...</h3>\n<ul>\n<li><div class="icon email"><a href="mailto: campaign@email.com">campaign@email.com</a></div></li>\n<li><div class="icon facebook"><a href="https://www.facebook.com/pages/Re-Elect-Marvin-Lucas/135037303354713" target="_blank">Facebook</a></div></li>\n</ul>', 'footer_right'),
